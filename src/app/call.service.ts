...
export class CallService {
  ...
  private localStreamBs: BehaviorSubject<MediaStream> =new BehaviorSubject(null as any);
  public localStream$=this.localStreamBs.asObservable();
  private remoteStreamBs: BehaviorSubject<MediaStream> =new  BehaviorSubject(null as any);
  ...
  public initPeer(): string | undefined {
    if (!this.peer || this.peer.disconnected) {
        ...
        try {
            let id:string = uuidv4() as string;
